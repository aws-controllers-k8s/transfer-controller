...
// +kubebuilder:rbac:groups=transfer.services.k8s.aws,resources=webapps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=transfer.services.k8s.aws,resources=webapps/status,verbs=get;update;patch
