...
const (
	FinalizerString = "finalizers.transfer.services.k8s.aws/WebApp"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("webapps")
	GroupKind            = metav1.GroupKind{
		Group: "transfer.services.k8s.aws",
		Kind:  "WebApp",
	}
)
