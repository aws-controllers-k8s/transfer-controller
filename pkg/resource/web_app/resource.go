...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.WebAppID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["webAppID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: webAppID"))
	}
	r.ko.Status.WebAppID = &tmp
