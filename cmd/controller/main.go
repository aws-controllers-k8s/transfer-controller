...
import (
	...
	svctypes "github.com/aws-controllers-k8s/transfer-controller/apis/v1alpha1"
	svcresource "github.com/aws-controllers-k8s/transfer-controller/pkg/resource"

	_ "github.com/aws-controllers-k8s/transfer-controller/pkg/resource/web_app"

	"github.com/aws-controllers-k8s/transfer-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "transfer.services.k8s.aws"
	awsServiceAlias    = "transfer"
